<template>
  <v-container fluid grid-list-md>
      <v-layout row id="my-cv-text" wrap>
        <v-flex md8 offset-md2>
          ...
          <b>In future: </b>For login to the backend I use Azure AD B2C which handles the authentication and holds all the user accounts. The data storage itself is
          implemented with CosmosDB. Again both service autoscale and I don't need to take care of the management of them.
          <br><br>

          <img src="@/assets/architecture.jpg" id="architecure">
          <br><br>
          ...
          €2.20 (without the CDN just €0.39) and is composed of: 
          <br><br>
        </v-flex>
        <v-flex sm2></v-flex>


        <v-flex offset-md2 md8 sm12 xs12>
          <v-card>
